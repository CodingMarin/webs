<footer class="pt-50 pb-20 bg-grey" style="border-top: 1px solid#bdc3c7;">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="sidebar-widget wow fadeInUp animated mb-30">
                    <div class="widget-header-2 position-relative mb-30">
                        <h5 class="mt-5 mb-30">Quien soy</h5>
                    </div>
                    <div class="textwidget">
                        <p>
                            Desarrollador full stack con 5 años en el campo de desarrollo.
                        </p>
                        <p><strong class="color-black">Direccion</strong><br>
                            123 Main Street<br>
                            New York, NY 10001</p>
                        <p><strong class="color-black">Sigueme en</strong><br>
            ...
            <div class="col-lg-2 col-md-6">
                <div class="sidebar-widget widget_categories wow fadeInUp animated mb-30" data-wow-delay="0.1s">
                    <div class="widget-header-2 position-relative mb-30">
                        <h5 class="mt-5 mb-30">Servicios</h5>
                    </div>
                    <ul class="font-small">
        ...
        <div class="footer-copy-right pt-30 mt-20 wow fadeInUp animated">
            ...
            <p class="float-md-right font-small text-muted">
                Desarrollado <a href="https://alithemes.com" target="_blank">Alexander Marin</a> | Todos los derechos reservados
            </p>
        </div>
    </div>
</footer>