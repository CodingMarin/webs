...
<div class="stars">
  ...
  <div class="center">
    ...
    <div class="circle circle--inner">
      ...
      <div class="button" onclick="window.location.href='http://localhost/www/index.php'">Reintentar</div>
    </div>
    <div class="sorry">Oops! Lo siento algo salio mal :C.</div>  
